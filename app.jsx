...
const I18N = {
  en: {
    ...
    edu: {
      ...
      items: [
        { date: "Since 2025", current: true, h: "PhD · Chemical Biotechnology", inst: <>The University of Tokyo, <Lnk to={LINKS.iis}>IIS</Lnk> · <Lnk to={LINKS.tsuboyama}>Tsuboyama Lab</Lnk></>, detail: "AI-assisted protein design under Prof. Kotaro Tsuboyama." },
        ...
        { date: "2022–2024", h: "MSc · Life Sciences", inst: <>The University of Tokyo, <Lnk to={LINKS.iqb}>IQB</Lnk> · <Lnk to={LINKS.okada}>Okada Lab</Lnk></>, detail: "Built a method for reversible decondensation–recondensation of sperm chromatin and verified development by ICSI from epigenome-edited sperm. Outstanding Graduate Award." },
    ...
    pubs: {
      ...
      papersTitle: "Papers",
      papers: [
        { date: "2026", status: "Under review", title: "Quantitative Kinetic Analysis of Protein–Phosphoinositide Binding by Optimized Liposome-Based Bio-Layer Interferometry", authors: "Yao P., Nishimura T., Tsuboyama K.", venue: <><Lnk to={LINKS.acsBiochem}>Biochemistry (ACS)</Lnk>, submitted</> },
      ],
      papersEmpty: "More first-author manuscripts in preparation. Stay tuned.",
      fundingTitle: "Funding",
      funding: { title: "JST SPRING-GX", desc: <>Japan Science & Technology Agency, <Lnk to={LINKS.springGX}>Support for Pioneering Research Initiated by the Next Generation: Green Transformation Program for Advanced Human Resource Development</Lnk>.</> },
    ...
    news: {
      ...
      title: "What's new.",
      items: [
        { when: "2026 · 04", h: "BLI manuscript submitted", p: <>Submitted to <Lnk to={LINKS.acsBiochem}>Biochemistry (ACS)</Lnk>: quantitative kinetic analysis of protein–phosphoinositide binding by optimized liposome-based BLI.</> },
  ...
  zh: {
    ...
    edu: {
      ...
      items: [
        { date: "2025 至今", current: true, h: "博士 · 化学生命工学", inst: <>东京大学 <Lnk to={LINKS.iis}>生研所</Lnk> · <Lnk to={LINKS.tsuboyama}>坪山研究室</Lnk></>, detail: "在坪山幸太郎讲师指导下，从事 AI 辅助蛋白质设计。" },
        { date: "2024–2025", h: "研究生", inst: <>东京大学 <Lnk to={LINKS.iis}>生研所</Lnk> · <Lnk to={LINKS.tsuboyama}>坪山研究室</Lnk></>, detail: "加入实验室，启动脂质结合筛选。" },
        { date: "2022–2024", h: "硕士 · 生命科学", inst: <>东京大学 <Lnk to={LINKS.iqb}>定量所</Lnk> · <Lnk to={LINKS.okada}>岡田研究室</Lnk></>, detail: "建立了精子染色质可逆解凝缩与再凝缩的方法，并通过 ICSI 验证表观遗传编辑后精子的发育。优秀毕业生奖。" },
    ...
    pubs: {
      ...
      papersTitle: "论文",
      papers: [
        { date: "2026", status: "审稿中", title: "通过优化的脂质体生物层干涉法定量分析蛋白质对磷脂酰肌醇的结合动力学", authors: "Yao P., Nishimura T., Tsuboyama K.", venue: <><Lnk to={LINKS.acsBiochem}>Biochemistry (ACS)</Lnk>，投稿中</> },
      ],
      papersEmpty: "其他第一作者论文正在撰写中。敬请期待。",
      fundingTitle: "资助",
      funding: { title: "JST SPRING-GX", desc: <>日本科学技术振兴机构（JST），<Lnk to={LINKS.springGX}>次世代研究者挑战性研究项目 · 绿色转型高级人才培养计划</Lnk>。</> },
      awardsTitle: "奖励 & 活动",
      awards: [
    ...
    news: {
      ...
      title: "最近发生了什么。",
      items: [
        { when: "2026 · 04", h: "BLI 论文投稿", p: <>向 <Lnk to={LINKS.acsBiochem}>Biochemistry (ACS)</Lnk> 投稿：通过优化的脂质体生物层干涉法定量分析蛋白质对磷脂酰肌醇的结合动力学。</> },
  ...
  ja: {
    ...
    edu: {
      ...
      items: [
        { date: "2025–現在", current: true, h: "博士課程 · 化学生命工学", inst: <>東京大学 <Lnk to={LINKS.iis}>生研</Lnk> · <Lnk to={LINKS.tsuboyama}>坪山研究室</Lnk></>, detail: "坪山幸太郎講師のもと、AI 支援タンパク質設計。" },
        { date: "2024–2025", h: "研究生", inst: <>東京大学 <Lnk to={LINKS.iis}>生研</Lnk> · <Lnk to={LINKS.tsuboyama}>坪山研究室</Lnk></>, detail: "ラボに参加、脂質結合スクリーニングを開始。" },
        { date: "2022–2024", h: "修士 · 生命科学", inst: <>東京大学 <Lnk to={LINKS.iqb}>定量研</Lnk> · <Lnk to={LINKS.okada}>岡田研究室</Lnk></>, detail: "精子クロマチンの可逆的な脱凝縮と再凝縮の手法を確立し、エピゲノム編集後の精子から ICSI による発生を確認。優秀修了生表彰。" },
    ...
    pubs: {
      ...
      papersTitle: "論文",
      papers: [
        { date: "2026", status: "審査中", title: "最適化したリポソームベース・バイオレイヤー干渉法によるタンパク質とホスホイノシチドの結合動態の定量解析", authors: "Yao P., Nishimura T., Tsuboyama K.", venue: <><Lnk to={LINKS.acsBiochem}>Biochemistry (ACS)</Lnk>、投稿中</> },
      ],
      papersEmpty: "他の筆頭著者論文を準備中。お楽しみに。",
      fundingTitle: "助成",
      funding: { title: "JST SPRING-GX", desc: <>科学技術振興機構（JST）、<Lnk to={LINKS.springGX}>次世代研究者挑戦的研究プログラム · GX 高度人材育成</Lnk>。</> },
      awardsTitle: "受賞・活動",
      awards: [
    ...
    news: {
      ...
      title: "最近の出来事。",
      items: [
        { when: "2026 · 04", h: "BLI 論文を投稿", p: <><Lnk to={LINKS.acsBiochem}>Biochemistry (ACS)</Lnk> に投稿：最適化リポソームベース BLI によるタンパク質とホスホイノシチドの結合動態の定量解析。</> },
...
// LINKS and Lnk are now declared at the top of this file (before I18N).
